...
def get_meril_nodes():
    ...
    for identifier, infrastructure in infrastructures.items():
        ...
        place = {
            ...
            'typeOfRI': locationtypes,  # list
            'keywords': infrastructure.get("Scientific Description", {}).get("riKeywords", []),
            'categories': infrastructure.get("Classifications", {}).get("riCategory", []),
            'esfriDomain': infrastructure.get("scientificDomain", {}).get("esfriDomain", []),
        }
